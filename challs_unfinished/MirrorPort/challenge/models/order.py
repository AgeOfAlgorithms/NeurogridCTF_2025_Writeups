"""
Order model for the Ninja Scroll Marketplace challenge.
Represents buyer purchases with scroll selections and notes.
"""
...
class Order:
    """Represents a buyer purchase."""
    
    def __init__(self, id: int, buyer_name: str, scroll_id: int, note: str = '', 
                 urls: List[str] = None, total: float = 0.0, is_processed: bool = False,
